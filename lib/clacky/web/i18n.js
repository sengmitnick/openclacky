...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "skills.store.empty":         "No skills available.",
      "skills.store.installed":     "Installed",
      "skills.store.install":       "Install",
      ...
      "channels.subtitle":        "Connect IM platforms so your users can chat with the assistant via Feishu or WeCom",
    ...
    zh: {
      ...
      "skills.store.empty":         "暂无可用技能。",
      "skills.store.installed":     "已安装",
      "skills.store.install":       "安装",
      ...
      // ── Channels panel ──
      "channels.title":           "频道",
      "channels.subtitle":        "连接即时通讯平台，让用户通过飞书或企业微信与助手对话",
  ...
  function setLang(code) {
    ...
    applyAll();
    // Notify any listeners (e.g. plugins) that language has changed
    document.dispatchEvent(new CustomEvent("i18n:langchange", { detail: { lang: _lang } }));
  }
